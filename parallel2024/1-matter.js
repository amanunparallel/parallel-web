...
//     let randomX = Math.random() * (matterContainerWidth - 26);
//     let randomY = Math.random() * (matterContainerHeight - 26);
//     let randomRotation = Math.random() * Math.PI * 2;

//     let rectangle = Bodies.rectangle(randomX, randomY, 26, 26, {
//       friction: 0.3,
//       frictionAir: 0.00001,
//       restitution: 0.8,
//       render: {
...
function thankyouPageBottomRectanglesAnimation() {
  ...
  for (let i = 0; i < numRectangles; i++) {
    ...
    let rectangle = Bodies.rectangle(randomX, randomY, rectangleWidth, rectangleHeight, {
      friction: 0.3,
      frictionAir: 0.00001,
      restitution: 0.8,
      render: {
  ...
  window.addEventListener("devicemotion", function(event) {
    ...
    // Move rectangles based on device motion
    for (let rectangle of rectangles) {
      var velocityX = rectangleSpeed * accelerationX;
      var velocityY = rectangleSpeed * accelerationY;

      Matter.Body.setVelocity(rectangle, { x: velocityX, y: velocityY });
    }
  });
}
